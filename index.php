<?php
  ...
  if(isset($_POST['bsimpan']))
  {
    ...
    {
      //Data akan diedit
      $edit = mysqli_query($koneksi, "UPDATE crud2022 Set 
                                        nim = '$_POST[tnim]',
                                        nama = '$_POST[tnama]',
    ...
    }else
    {
      ...
      $simpan = mysqli_query($koneksi, "INSERT INTO crud2022 (nim, nama, alamat, prodi, jk, umur)
                                     VALUES ('$_POST[tnim]', 
                                            '$_POST[tnama]', 
                                            '$_POST[talamat]', 
                                            '$_POST[tprodi]', 
  ...
  if(isset($_GET['hal']))
  {
    ...
    if($_GET['hal'] == "edit")
    {
      ...
      $tampil = mysqli_query($koneksi, "SELECT * FROM crud2022 WHERE no = '$_GET[id]' ");
    ...
    if($_GET['hal'] == "hapus")
    {
      ...
      $hapus = mysqli_query($koneksi, "DELETE FROM crud2022 WHERE no = '$_GET[id]' ");
      if($hapus)
      {
        echo "<script>
...
<h1 class="text-center">WEB ARON</h1>
<h2 class="text-center">ARON DALONTO</h2>
...
<div class="card mt-3">
  ...
  <div class="card-body">
    ...
    <table class="table table-bordered table-striped">
      ...
      <?php
          $no=1;
          $tampil = mysqli_query($koneksi, "select * from crud2022 order by no asc");
